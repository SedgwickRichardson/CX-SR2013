 ...
 */
define('GOOGLE_ANALYTICS_ID', 'UA-22804685-12'); // UA-XXXXX-Y (Note: Universal Analytics only, not Classic Analytics)
...
function roots_sidebar_class() {
  return 'col-sm-3 col-sm-pull-9 hidden-xs visible-sm visible-md visible-lg';
}
