...
var Roots = {
  ...
  common: {
    init: function() {
      ...
      function initVideo(){
        ...
        window.onYouTubePlayerAPIReady = function(){
          ...
          $("#video-popup .ytplayer").each(function() {
            yt_players[$(this).attr('id')] = new YT.Player($(this).attr('id'));
            console.log("yt_players="+yt_players[$(this).attr('id')]+" this.id="+$(this).attr('id'));
          });
        ...
        $('#video-carousel .owl-item').each(function(){
           ...
           $(this).find('a').click(function(evt){
            ...
            $('#embed-video-container>div').each(function(){
              console.log("$(this).index()="+$(this).index()+" slide_index="+slide_index);
              if($(this).index()===slide_index){
                return;
              }
              
              console.log("yt_players="+yt_players['player_'+$(this).index()]+" $(this).index()="+$(this).index());
              var player = yt_players['player_'+$(this).index()];
               console.log("before pauseVideo of player player_"+$(this).index());
      ...
      function initSearch(){
        var cx = '003050160993696772205:jikybs9hxmk'; // Insert your own Custom Search engine ID here
  ...
  home: {
    init: function() {
      ...
      //put the codes in onload instead on docu ready to fix the parallax bug in safari
      $(window).on('load', function() {
      /*$(document).ready(function(){*/
        setupBannerRotator();
